            ...
            <div class="row justify-content-center">
                    ...
                    <div class="white_card card_height_100 mb_30">
                        ...
                        <div class="white_card_body">
                            <div class="form-group mb-0">
                                <input  value="" type="text" class="form-control" name="name" id="name" placeholder="Nhập tên sản phẩm...">
                            </div>
                            <br>
                            @if($errors->has('name'))
                ...
                <div class="col-lg-4">
                    <div class="white_card card_height_100 mb_30">
                        ...
                        <div class="white_card_body">
                            <div class="form-group mb-0">
                                <input  value="" type="text" class="form-control" name="price" id="slug" placeholder="Nhập giá sản phẩm...">
                            </div>
                            <br>
                            @if($errors->has('name'))
                                <h6 class="card-subtitle mb-2 mb-2"><code>{{ $errors->first('name') }}</code></h6>
                ...
                <div class="col-lg-4">
                    <div class="white_card card_height_100 mb_30">
                        ...
                        <div class="white_card_body">
                            <div class="form-group mb-0">
                                <input  value="" type="file" class="form-control" name="image_url" id="slug" placeholder="">
                            </div>
                            <br>
                            @if($errors->has('name'))
                                <h6 class="card-subtitle mb-2 mb-2"><code>{{ $errors->first('name') }}</code></h6>
