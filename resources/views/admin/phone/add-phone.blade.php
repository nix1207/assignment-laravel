...
@section('main_content')
    <div class="main_content_iner ">
        ...
        <div class="container-fluid p-0 sm_padding_15px">
            <form action="{{ route('admin.store.phone') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-4">
                        <div class="white_card card_height_100 mb_30">
                            ...
                            <div class="white_card_body">
                                <div class="form-group mb-0">
                                    <input value="" type="text" class="form-control" name="price" id="slug"
                    ...
                    <div class="col-lg-4">
                        <div class="white_card card_height_100 mb_30">
                            ...
                            <div class="white_card_body">
                                <div class="form-group mb-0">
                                    <input value="" type="file" class="form-control" name="image_url" id="imgInp"
                                        placeholder="">
                                    <img style="margin: 10px" id="blah" class="d-none" src="#" alt="your image"
                                        width="125px" />
                                </div>
                                <br>
                                @if ($errors->has('image_url'))
                                    <h6 class="card-subtitle mb-2 mb-2"><code>{{ $errors->first('image_url') }}</code>
                                    </h6>
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="white_card card_height_100 mb_30">
                            ...
                            <div class="white_card_body">
                                <div class="form-group mb-0">
                                    <textarea id="maxlength-textarea" cols="30" rows="10" name="desc" class="form-control"></textarea>
                                </div>
                                <br>
                                <br>
                                @if ($errors->has('desc'))
