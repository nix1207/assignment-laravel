                                    ...
                                    <div class="modal-content cs_modal">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('login.admin') }}" method="post">
                                                ...
                                                <button type="submit"
                                                    style="background-color: #ff3333 ; border: none; font-weight: bold; "
                                                    class="btn_1 full_width text-center">
                                                    LOGIN
                                                </button>
                                                <a style="background-color: #4873C8 ; font-weight: bold" href="#"
                                                    class="btn_1 full_width text-center"><i
                                                        style="background-color: white ; color:#1877F2 ;  ; font-size: 25px "
