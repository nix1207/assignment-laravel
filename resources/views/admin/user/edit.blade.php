            ...
            <div class="row justify-content-center">
                    ...
                    <div class="white_card card_height_100 mb_30">
                        ...
                        <div class="white_card_body">
                            ...
                            <div class="form-group mb-0">
                                <input  value=" {{ $user->name }} " type="text" class="form-control" name="name" id="slug" placeholder="Nhập họ và tên">
                            </div>
                            <br>
                            @if($errors->has('name'))
                ...
                <div class="col-lg-6">
                    <div class="white_card card_height_100 mb_30">
                        ...
                        <div class="white_card_body">
                            ...
                            <div class="form-group mb-0">
                                <input  value="{{ $user->email }}" type="text" class="form-control" name="email" id="slug" placeholder="Nhập email">
                            </div>
                            <br>
                            @if($errors->has('email'))
                        ...
                        <div class="white_card_body">
                            ...
                            <div class="form-group mb-0">
                                <div class="input-group common_date_picker">
                                    <input value="{{ $user->birthday }}" autocomplete="off"
                ...
                <div class="col-lg-6">
                    <div class="white_card card_height_100 mb_30">
                        ...
                        <div class="white_card_body">
                            <div class="form-group mb-0">
                                <input value="on"  type="checkbox" class="form-control" name="status" id="inputEmail" {{ $user->status == 1 ? 'checked' : '' }} >
                            </div>
